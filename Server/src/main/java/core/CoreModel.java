...
public class CoreModel implements CommunicationControllerDAO {
    ...
    private ReservedTreasures reservedTreasures;
    ...
    public boolean isReservedForUser(int treasureID, int token) {
        return reservedTreasures.isReservedfor(treasureID, token);
    }

    public boolean isReserved(int treasureID) {
        return reservedTreasures.isReserved(treasureID);
    }

    public void addTreasureReservation(int treasureID, int token) {
        reservedTreasures.reserveTreasure(token, treasureID);
    }

    public void deleteTreasureReservation(int token, int tid) {
        reservedTreasures.deleteReservationFor(token, tid);
    }
