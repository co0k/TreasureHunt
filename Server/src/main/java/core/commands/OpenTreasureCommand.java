		...
		if(db.openTreasure(uid, tid)) {
			...
			if(tHistory.size() + 1 == 5) {
				...
				if (!contentList.contains(t5)) {
					...
					db.updateScore(uid, db.getTreasure(tid).getXP() + t5.getContent().getXP());
				}
				...
				if (!contentList.contains(t10)) {
					...
					db.updateScore(uid, db.getTreasure(tid).getXP() + t10.getContent().getXP());
				}
				...
				if (!contentList.contains(t20)) {
					...
					db.updateScore(uid, db.getTreasure(tid).getXP() + t20.getContent().getXP());
				}
				...
				if (!contentList.contains(t50)) {
					...
					db.updateScore(uid, db.getTreasure(tid).getXP() + t50.getContent().getXP());
				}
				...
				if (!contentList.contains(t100)) {
					...
					db.updateScore(uid, db.getTreasure(tid).getXP() + t100.getContent().getXP());
				}
				...
				if (!contentList.contains(t500)) {
					...
					db.updateScore(uid, db.getTreasure(tid).getXP() + t500.getContent().getXP());
				}
				...
				if (!contentList.contains(t1000)) {
					...
					db.updateScore(uid, db.getTreasure(tid).getXP() + t1000.getContent().getXP());
				}
			}
